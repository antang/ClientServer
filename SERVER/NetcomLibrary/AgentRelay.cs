...
namespace NetcomLibrary
{
    ...
    public class AgentRelay : NetComm
    {
        ...
        public bool SendMessage(int cmd)
        {
            ...
            return SendMessage(new byte[0], cmd);
        }
        ...
        public bool SendMessage(string content, int cmd)
        {
            return SendMessage(System.Text.Encoding.ASCII.GetBytes(content), cmd);
            //SendMessage(cmd, System.Text.Encoding.ASCII.GetBytes(content));
        }
        ...
        public bool SendMessage(byte[] content, int cmd)
        {
